...
//Gnuplot parameters
 ...
 std::string fileNameWithNoExtension = "FlowVSThroughput5to1";
...
AnimationInterface anim ("animation5to1.xml");
...
//Gnuplot ...continued
  ...
  monitor->SerializeToXmlFile("openflow5to1.flowmon", true, true);
  Simulator::Destroy ();
