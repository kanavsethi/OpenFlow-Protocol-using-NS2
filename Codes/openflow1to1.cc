...
//Gnuplot parameters
 ...
 std::string fileNameWithNoExtension = "FlowVSThroughput1to1";
...
AnimationInterface anim ("animation1to1.xml");
...
//Gnuplot ...continued
  ...
  monitor->SerializeToXmlFile("openflow1to1.flowmon", true, true);
  Simulator::Destroy ();
