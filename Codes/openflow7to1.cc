...
//Gnuplot parameters
 ...
 std::string fileNameWithNoExtension = "FlowVSThroughput7to1";
...
AnimationInterface anim ("animation7to1.xml");
...
//Gnuplot ...continued
  ...
  monitor->SerializeToXmlFile("openflow7to1.flowmon", true, true);
  Simulator::Destroy ();
