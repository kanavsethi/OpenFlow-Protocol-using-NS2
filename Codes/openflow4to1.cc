...
//Gnuplot parameters
 ...
 std::string fileNameWithNoExtension = "FlowVSThroughput4to1";
...
AnimationInterface anim ("animation4to1.xml");
...
//Gnuplot ...continued
  ...
  monitor->SerializeToXmlFile("openflow4to1.flowmon", true, true);
  Simulator::Destroy ();
