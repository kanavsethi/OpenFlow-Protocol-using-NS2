...
//Gnuplot parameters
 ...
 std::string fileNameWithNoExtension = "FlowVSThroughput6to1";
...
AnimationInterface anim ("animation6to1.xml");
...
//Gnuplot ...continued
  ...
  monitor->SerializeToXmlFile("openflow6to1.flowmon", true, true);
  Simulator::Destroy ();
