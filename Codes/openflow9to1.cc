...
//Gnuplot parameters
 ...
 std::string fileNameWithNoExtension = "FlowVSThroughput9to1";
...
AnimationInterface anim ("animation9to1.xml");
...
//Gnuplot ...continued
  ...
  monitor->SerializeToXmlFile("openflow9to1.flowmon", true, true);
  Simulator::Destroy ();
